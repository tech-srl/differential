...
add_field (int file, size_t field)
{
  ...
  ((file == 0 || file == 1 || file == 2) ? (void) (0) : __assert_fail ("file == 0 || file == 1 || file == 2", "join.c", 586, __PRETTY_FUNCTION__));
  ((file != 0 || field == 0) ? (void) (0) : __assert_fail ("file != 0 || field == 0", "join.c", 587, __PRETTY_FUNCTION__));
...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "join", "GNU coreutils", "6.10", "Mike Haertel", (char *) ((void *)0)); exit (0); break;;
