...
abandon_move (const struct cp_options *x,
              ...
              struct stat const *dst_sb)
{
  ((x->move_mode) ? (void) (0) : __assert_fail ("x->move_mode", "copy.c", 1013, __PRETTY_FUNCTION__));
...
{
  ((co != ((void *)0)) ? (void) (0) : __assert_fail ("co != ((void *)0)", "copy.c", 2067, __PRETTY_FUNCTION__));
  ((((unsigned int) (co->backup_type) <= numbered_backups)) ? (void) (0) : __assert_fail ("((unsigned int) (co->backup_type) <= numbered_backups)", "copy.c", 2068, __PRETTY_FUNCTION__));
  ((((co->sparse_mode) == SPARSE_NEVER || (co->sparse_mode) == SPARSE_AUTO || (co->sparse_mode) == SPARSE_ALWAYS)) ? (void) (0) : __assert_fail ("((co->sparse_mode) == SPARSE_NEVER || (co->sparse_mode) == SPARSE_AUTO || (co->sparse_mode) == SPARSE_ALWAYS)", "copy.c", 2069, __PRETTY_FUNCTION__));
  ((!(co->hard_link && co->symbolic_link)) ? (void) (0) : __assert_fail ("!(co->hard_link && co->symbolic_link)", "copy.c", 2070, __PRETTY_FUNCTION__));
  return 1;
}
# 2083 "copy.c"
extern _Bool
copy (char const *src_name, char const *dst_name,
      ...
      _Bool *copy_into_self, _Bool *rename_succeeded)
{
  ((valid_options (options)) ? (void) (0) : __assert_fail ("valid_options (options)", "copy.c", 2088, __PRETTY_FUNCTION__));
# 2097 "copy.c"
