...
binop (char const *s)
{
  return (((strcmp (s, "=") == 0)) || ((strcmp (s, "!=") == 0)) || ((strcmp (s, "-nt") == 0)) ||
...
binary_operator (_Bool l_is_l)
{
  ...
  if (argv[op][0] == '-')
   ...
   && !argv[op][3])
 {
   char lbuf[(((sizeof (uintmax_t) * 8 - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 / 485 + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1)) + 1) + 1)];
   char rbuf[(((sizeof (uintmax_t) * 8 - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 / 485 + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1)) + 1) + 1)];
   char const *l = (l_is_l
...
# 809 "test.c"
 ...
 {
   parse_long_options (margc, margv, "test", "GNU coreutils", "6.11",
         usage, "Kevin Braunsdorf", "Matthew Bradburn", (char const *) ((void *)0));
  ...
  exit (value ? TEST_TRUE : TEST_FALSE);
}
