...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "paste", "GNU coreutils", "6.10", "David M. Ihnat", "David MacKenzie", (char *) ((void *)0)); exit (0); break;;
