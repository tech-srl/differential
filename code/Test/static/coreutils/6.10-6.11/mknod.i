...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("  -Z, --context=CTX  set the SELinux security context of NAME to CTX\n"),stdout);
...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "mknod", "GNU coreutils", "6.10", "David MacKenzie", (char *) ((void *)0)); exit (0); break;;
 default:
   usage (1);
 }
    }
