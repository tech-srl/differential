...
We separate abstractions over guard variables added by the transformation to Guarded command language (GCL) format (see \secref{Correlating}) from original program variables as there need not be any relationships between guard and regular variables.
