...
pop_dir (Dirstack_state *ds)
{
  ...
  ((n_lengths > 0) ? (void) (0) : __assert_fail ("n_lengths > 0", "remove.c", 268, __PRETTY_FUNCTION__));
  size_t top_len = length[n_lengths - 1];
  ((top_len >= 2) ? (void) (0) : __assert_fail ("top_len >= 2", "remove.c", 270, __PRETTY_FUNCTION__));


  ((__extension__ ({ struct obstack const *__o = (&ds->dir_stack); (unsigned) (__o->next_free - __o->object_base); }) >= top_len) ? (void) (0) : __assert_fail ("__extension__ ({ struct obstack const *__o = (&ds->dir_stack); (unsigned) (__o->next_free - __o->object_base); }) >= top_len", "remove.c", 273, __PRETTY_FUNCTION__));
  ...
  ((__extension__ ({ struct obstack const *__o = (&ds->len_stack); (unsigned) (__o->next_free - __o->object_base); }) >= sizeof (size_t)) ? (void) (0) : __assert_fail ("__extension__ ({ struct obstack const *__o = (&ds->len_stack); (unsigned) (__o->next_free - __o->object_base); }) >= sizeof (size_t)", "remove.c", 277, __PRETTY_FUNCTION__));
 ...
 return ((void *)0);
  ...
  if ((strcmp (filename, ".") == 0) && rm_dir_len)
  ...
  else
    {
      ...
      ((strlen (g_buf) + 1 == n_bytes_needed) ? (void) (0) : __assert_fail ("strlen (g_buf) + 1 == n_bytes_needed", "remove.c", 347, __PRETTY_FUNCTION__));
    }
...
{
  ((0 < AD_stack_height (ds)) ? (void) (0) : __assert_fail ("0 < AD_stack_height (ds)", "remove.c", 427, __PRETTY_FUNCTION__));
...
# 521 "remove.c"
  ...
  ((AD_stack_height (ds)) ? (void) (0) : __assert_fail ("AD_stack_height (ds)", "remove.c", 527, __PRETTY_FUNCTION__));
...
AD_mark_current_as_unremovable (Dirstack_state *ds)
{
  ...
  ((1 < AD_stack_height (ds)) ? (void) (0) : __assert_fail ("1 < AD_stack_height (ds)", "remove.c", 636, __PRETTY_FUNCTION__));
...
# 1064 "remove.c"
   ...
   )
 {
   ...
   return RM_ERROR;
      ...
      ((!cache_stat_ok (st) || ((((st->st_mode)) & 0170000) == (0040000))) ? (void) (0) : __assert_fail ("!cache_stat_ok (st) || ((((st->st_mode)) & 0170000) == (0040000))", "remove.c", 1113, __PRETTY_FUNCTION__));
    }
  else
    {
      ...
      struct rm_options const *x)
{
  ...
  ((((status) == RM_OK || (status) == RM_USER_DECLINED || (status) == RM_ERROR)) ? (void) (0) : __assert_fail ("((status) == RM_OK || (status) == RM_USER_DECLINED || (status) == RM_ERROR)", "remove.c", 1233, __PRETTY_FUNCTION__));
  *subdir = ((void *)0);
 ...
 break;
  ...
  ((*dirp != ((void *)0)) ? (void) (0) : __assert_fail ("*dirp != ((void *)0)", "remove.c", 1345, __PRETTY_FUNCTION__));
  ((0 <= fcntl (dirfd (*dirp), 1)) ? (void) (0) : __assert_fail ("0 <= fcntl (dirfd (*dirp), 1)", "remove.c", 1346, __PRETTY_FUNCTION__));
...
# 1384 "remove.c"
 ...
 dirp = ((void *)0);
 ((fd != -100 || AD_stack_height (ds) == 1) ? (void) (0) : __assert_fail ("fd != -100 || AD_stack_height (ds) == 1", "remove.c", 1467, __PRETTY_FUNCTION__));
...
rm (size_t n_files, char const *const *file, struct rm_options const *x)
{
      ...
      else
 {
   ...
   ((((s) == RM_OK || (s) == RM_USER_DECLINED || (s) == RM_ERROR)) ? (void) (0) : __assert_fail ("((s) == RM_OK || (s) == RM_USER_DECLINED || (s) == RM_ERROR)", "remove.c", 1613, __PRETTY_FUNCTION__));
