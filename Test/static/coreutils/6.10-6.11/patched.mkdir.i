...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "mkdir", "GNU coreutils", "6.11", "David MacKenzie", (char *) ((void *)0)); exit (0); break;;
 default:
   usage (1);
 }
    }
  ...
  if (options.make_ancestor_function || specified_mode)
    {
      ...
      options.ancestor_mode = (((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) & ~umask_value) | (0200 | 0100);
 ...
 options.mode = ((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) & ~umask_value;
    }
