...
{
  static char str[((((((sizeof (intmax_t) * 8 - (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) * 146 / 485 + (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1)) + 1) + 1))>((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 / 485 + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1)) + 1) + 1 + sizeof "-MM-DD HH:MM:SS.NNNNNNNNN +ZZZZ")))?((((sizeof (intmax_t) * 8 - (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) * 146 / 485 + (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1)) + 1) + 1)):((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 / 485 + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1)) + 1) + 1 + sizeof "-MM-DD HH:MM:SS.NNNNNNNNN +ZZZZ")))];
       ...
       void const *data)
{
 ...
 extern int (* verify_function__ (void)) [(!!sizeof (struct { unsigned int verify_error_if_negative_size__: (__builtin_offsetof (struct { char c; struct statfs x; }, x) % __builtin_offsetof (struct { char c; fsid_word x; }, x) == 0) ? 1 : -1; }))];
 extern int (* verify_function__ (void)) [(!!sizeof (struct { unsigned int verify_error_if_negative_size__: (__builtin_offsetof (struct statfs, f_fsid) % __builtin_offsetof (struct { char c; fsid_word x; }, x) == 0) ? 1 : -1; }))];
 extern int (* verify_function__ (void)) [(!!sizeof (struct { unsigned int verify_error_if_negative_size__: (sizeof statfsbuf->f_fsid % __builtin_offsetof (struct { char c; fsid_word x; }, x) == 0) ? 1 : -1; }))];
     ...
     char const *filename, void const *data)
{
 ...
 out_int (pformat, prefix_len, statbuf->st_atim.tv_sec);
      else
 out_uint (pformat, prefix_len, statbuf->st_atim.tv_sec);
      break;
    case 'y':
    ...
    case 'Y':
      if ((! ((time_t) 0 < (time_t) -1)))
 out_int (pformat, prefix_len, statbuf->st_mtim.tv_sec);
      else
 out_uint (pformat, prefix_len, statbuf->st_mtim.tv_sec);
      break;
    case 'z':
    ...
    case 'Z':
      if ((! ((time_t) 0 < (time_t) -1)))
 out_int (pformat, prefix_len, statbuf->st_ctim.tv_sec);
      else
 out_uint (pformat, prefix_len, statbuf->st_ctim.tv_sec);
      break;
    case 'C':
      out_file_context (filename, pformat, prefix_len);
      break;
   ...
   void const *data)
{
 ...
 ((((sizeof "ll" "d")>((((sizeof "ll" "o")>((((sizeof "ll" "u")>(sizeof "ll" "x"))?(sizeof "ll" "u"):(sizeof "ll" "x"))))?(sizeof "ll" "o"):((((sizeof "ll" "u")>(sizeof "ll" "x"))?(sizeof "ll" "u"):(sizeof "ll" "x"))))))?(sizeof "ll" "d"):((((sizeof "ll" "o")>((((sizeof "ll" "u")>(sizeof "ll" "x"))?(sizeof "ll" "u"):(sizeof "ll" "x"))))?(sizeof "ll" "o"):((((sizeof "ll" "u")>(sizeof "ll" "x"))?(sizeof "ll" "u"):(sizeof "ll" "x"))))))
...
static _Bool
do_statfs (char const *filename, _Bool terse, char const *format)
{
...
static _Bool
do_stat (char const *filename, _Bool terse, char const *format)
{
  struct stat statbuf;
...
main (int argc, char *argv[])
{
  ...
  while ((c = getopt_long (argc, argv, "c:fLtZ", long_options, ((void *)0))) != -1)
    {
      switch (c)
 {
 case PRINTF_OPTION:
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "stat", "GNU coreutils", "6.11", "Michael Meskes", (char *) ((void *)0)); exit (0); break;;
