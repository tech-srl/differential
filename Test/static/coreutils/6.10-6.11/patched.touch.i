...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "touch", "GNU coreutils", "6.11", "Paul Rubin", "Arnold Robbins, Jim Kingdon, David MacKenzie", "Randy Smith", (char *) ((void *)0)); exit (0); break;;
