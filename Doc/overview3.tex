...
\COMMENT{? maybe show a bigger example that better shows how we benefit from partitioning}

\COMMENT{? talk about how merging early in paths may affect equivalence and differencing behaviors further along} 