...
\begin{figure}
\imagetop{
\includegraphics[scale=0.18,clip=true,trim = 100pt 150pt 100pt 150pt]{figures/sign-result.jpg}
}
\caption{Abstract characterization of $sign$ (blue) and $sign'$ (red) behaviors}\figlabel{SignResult}
\end{figure}
