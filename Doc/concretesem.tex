...
\paragraph{Correlating Concrete State} \deflabel{ConcreteState}
...
\paragraph{Correlating Concrete Trace} \deflabel{ConcreteTrace}
...
\paragraph{Correlating Collecting Semantics of a Program Label} \deflabel{ProgramLabelCollectingSemantics}
