...
\paragraph{Product Program} \deflabel{ProductProgram}

We omit explicit definitions for dual state and trace as they are induces by the underlying definitions for a single program.
